...
In addition to several descriptive analyses, we performed inverse proability weighting (ipw) method for analyzing the effects of each treatment on the outcome variable.

* __Outcome Variable for \colorbox{purple!50}{Q2-A}__
\
```{r Q2-A-1, fig.align = 'center', out.width = "70%", echo=FALSE}
knitr::include_graphics("figures/model_q2a_1_comparisons.png")
```
  ...
  + Similarly, our results show that differnet levels of incentives through the program yield unexpected causal impacts on amount loaded:
   
   
```{r Q2-A-2, fig.align = 'center', out.width = "70%", echo=FALSE}
knitr::include_graphics("figures/model_q2a_2_comparisons.png")
```
...
knitr::include_graphics("figures/model_q2a_3_comparisons.png")
```
